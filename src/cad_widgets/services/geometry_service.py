...
class GeometryService:
    ...
    @staticmethod
    def fuse_shapes(shape1: TopoDS_Shape, shape2: TopoDS_Shape) -> Optional[TopoDS_Shape]:
        """
    ...
    @staticmethod
    def cut_shapes(shape1: TopoDS_Shape, shape2: TopoDS_Shape) -> Optional[TopoDS_Shape]:
        """
    ...
    @staticmethod
    def intersect_shapes(shape1: TopoDS_Shape, shape2: TopoDS_Shape) -> Optional[TopoDS_Shape]:
        """
